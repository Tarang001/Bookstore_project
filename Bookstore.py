...
mydb=mysql.connector.connect(host="localhost",user="root",password="apk123")
...
==========================================================================""")
                ...
                mycursor.execute("create table if not exists Available_Books(BookName varchar(60) primary key,Genre varchar(20),Quantity int(3),Author varchar(32),Publication varchar(30),Price int(4))")
                mycursor.execute("create table if not exists Sell_rec(CustomerName varchar(32),PhoneNumber char(10) unique key, BookName varchar(60),Quantity int(100),Price int(4),foreign key (BookName) references Available_Books(BookName))")
                mycursor.execute("create table if not exists Staff_details(Name varchar(32), Gender varchar(10),Age int(3), PhoneNumber char(10) unique key , Address varchar(40))") 
                mydb.commit()
